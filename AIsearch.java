...
public class AIsearch {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int[][] numberedMap=loadMap("large maze.txt"); //numberedMap is used initially for setting up nodes and drawing
     ...
     /*(   mazeDrawer.updateBoard(x1+1,y1,0);
        ...
        BFS.search(tiles, start, numberedMap, width);
        //GBFS.search(tiles, start, goal, numberedMap, width);
